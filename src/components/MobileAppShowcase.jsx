...
const StatCard = ({ number, label }) => (
  <div className="text-center p-4">
    {/* <h3 className="text-4xl font-bold text-blue-900 mb-2"></h3> */}
    <h3 className="text-4xl font-bold text-gray-900 bg-gradient-to-r from-[#FFA229] to-[#1C4670] text-transparent bg-clip-text">
      {number}
    </h3>
    <p className="text-sm text-gray-600 font-bold tracking-wider">{label}</p>
  </div>
);
...
const MobileAppShowcase = () => {
  ...
  return (
    <section className="relative ">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            ...
            <div className="space-y-4 sm:space-y-0 sm:space-x-4 flex flex-col sm:flex-row">
              ...
              <a
                href="#"
                className="inline-flex items-center bg-white text-green-400 px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors duration-200"
              >
                <svg
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative w-full max-w-md mx-auto">
              <img src="/mobile.png" alt="iPhone Mockup" className="w-full" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[linear-gradient(96.22deg,#FFA229_9%,#1C4670_59.37%)] text-white py-20 px-4"

      >
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-sm font-medium mb-4 inline-block">
            1% OF THE INDUSTRY
          </span>
