...
const About = () => {
  return (
    <section id='about-us' className="py-16 bg-white relative overflow-hidden max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <p className="text-yellow-600 font-semibold">WELCOME TO REGISTERKARO.IN</p>
