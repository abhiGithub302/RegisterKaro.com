    ...
    <section className="py-16 px-4 max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div id="blog" className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-secondary font-semibold mb-2">EXPLORE OUR BLOGS</p>
        ...
        <div className="text-center mt-12">
          <button className="bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary transition-colors duration-300">
            Show more blogs
          </button>
        </div>
      </div>
