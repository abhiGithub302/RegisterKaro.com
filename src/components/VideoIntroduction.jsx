...
const FeatureItem = ({ icon: Icon, title, description }) => (
  <div className="flex items-start space-x-4 mb-8">
    <div className="text-4xl text-primary mb-4 rounded-full w-16 h-16 bg-yellow-400 flex items-center justify-center">
...
const VideoIntroduction = () => {
  ...
  return (
    <section className="bg-[#1e3a8a] py-20 px-4 relative overflow-hidden mt-14">
      {/* Background Pattern */}
